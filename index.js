...
function showWorksSection() {
  ...
  hireUsNavbutton.classList.remove("hireUsButton--hidden");
}
...
function toggleBigMenu() {
  ...
  if (popupMenuActive) {
    pageWrapper.addEventListener("click", toggleBigMenu, {
      capture: true,
      once: true,
    });
  } else {
    pageWrapper.removeEventListener("click", toggleBigMenu, {
      capture: true,
      once: true,
    });
  }
